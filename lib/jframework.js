...
var jframeworkRoute = (function (utils, config) {
  ...
  var jframework = (function (jframeworkRoute, config, utils) {
  ...
  exports.run =function () {
    ...
    $('body').on('click', 'a', function (event) {
      ...
      jframeworkRoute.goTo(event.currentTarget.href.substr(location.origin.length)); 
    });

    if (config.popstate) {
      window.onpopstate = function () {
        jframeworkRoute.resolveRoute(location.pathname);
      };
    } else {
        // TODO: onhashchange
      }
      ...
      jframeworkRoute.goTo(location.pathname.substr(config.baseUrl.length));
    ...
    /*
     *  Creates a class string based on an object
     */
     exports.addClass = function (obj) {
      var classes = [];
      for (var prop in obj) {
  ...
  }(jframeworkRoute, config, utils));
var jframeworkAction = (function (EventEmitter) {
...
var jframeworkComponent = (function (utils) {

  var exports = {};

  var _components = [];
  exports.createDomNodeRepresentation = function (arg) {
  ...
  exports.jComponent.prototype = {
    ...
    _init: function (renders) {
      ...
      this._renders = this._renderCallback();
      if (!this._renders) {
    ...
    _render: function () {
      ...
      this._renders = this._renderCallback.call(this);
      this._isRendering = false;
    },
    ...
    _template: function () {
      ...
      for (var x = 0; x < renderArgs.length; x++) {
        ...
        var domNodeRepresentation = exports.createDomNodeRepresentation(renderArg);
...
return exports;
  ...
  var jframeworkState = (function (EventEmitter) {
    ...
    var state = function (constr) {
      var stateExports = function (exports) {
      ...
      stateExports.prototype = Object.create(EventEmitter.prototype);
      var base = function () {
        this._exports = null;
        this.exports = function (exports) {
          this._exports = new stateExports(exports);
        };
      };
      base.prototype = state.prototype;
      var newState = new base();
      constr.call(newState, newState.flush.bind(newState)) || {};
      return newState._exports;
    };
...
var jframeworkComponents = (function (jframeworkComponent, jframeworkRoute) {

  var component = jframeworkComponent.component;
  var router = jframeworkRoute;
  var exports = {};

  return exports;

}(jframeworkComponent, jframeworkRoute)); return {
